...
def pyx_library(name, deps = [], py_deps = [], srcs = [], **kwargs):
    ...
    for src in srcs:
        if src.endswith(".pyx") or (src.endswith(".py") and
            ...
            py_srcs.append(src)
        elif src.endswith(".cc") or src.endswith(".c") or src.endswith(".cpp") or src.endswith(".C"):
            c_srcs.append(src) 
        elif src.endswith(".hh") or src.endswith(".h") or src.endswith(".hpp"):
            c_hdrs.append(src)
        else:
            pxd_srcs.append(src)
